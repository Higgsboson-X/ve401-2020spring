...
\justifying
\structb{Definition.} An infinite set $A$ is \highlightg{countable} if there is a bijective function between the elements of $A$ and the set of natural numbers $\{1, 2, 3, \ldots\}$. A set is uncountable if it is neither finite nor countable.
~\\
~\\
\justifying
