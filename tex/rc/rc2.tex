...
\justifying
\structb{Definition.} Let $k\in \R$. A random variable $(X, f_X)$ with
\begin{align*}
X: S\rightarrow \N
\end{align*}
...
\end{align*}
is said to follow a \highlightg{Poisson distribution} with parameter $k$, which describes the occurrence of events that occur at a \underline{constant rate} and \underline{continuous environment}.
...
\justifying
\structb{Definition.} Let $r\in \N\setminus \{0\}$. A random variable $(X, f_X)$ with
\begin{align*}
...
\end{align*}
is said to follow a \highlightg{Pascal distribution} with parameters $p$ and $r$.
...
\end{align*}
is said to follow a \highlightg{negative binomial distribution} with parameters $p$ and $r$.
